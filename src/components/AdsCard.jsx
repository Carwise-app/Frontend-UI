...
export default function AdsCard() {
  return (
     <Box className="grid grid-cols-[2fr_4fr_2fr_1fr_1fr] w-full max-h-30 h-30 bg-white rounded-sm shadow-sm gap-x-1 cursor-pointer transition-transform duration-300 hover:-translate-y-1">
      ...
      <Box className="flex flex-col items-center justify-center border-l border-gray-100">
