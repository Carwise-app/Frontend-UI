...
export default function FavAdsCard() {
  return (
   <Box className="grid grid-cols-[1fr_2fr_1fr_1fr] w-full max-h-30 h-30 bg-white rounded-sm shadow-md gap-x-1 cursor-pointer transition-transform duration-300 hover:-translate-y-1">
